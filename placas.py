...
cap = cv2.VideoCapture("/home/vinicius/git/placas/imagens/frente-02.mp4")
i = 1
...
while (1):
    ...
    #    img[:, :, 2] = 0 # zerando o canal B (BLUE)
        ...
        imgNormal = cv2.resize(img, dim, interpolation=cv2.INTER_LINEAR_EXACT)
        ...
        for listChar in listaCombinada:
            ...
            if possivelPlaca.imgPlaca is not None and possivelPlaca.W < 300 :
